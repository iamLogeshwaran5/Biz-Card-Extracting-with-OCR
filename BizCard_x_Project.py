...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Logeshwaran C",
                   page_icon= icon,
                   layout= "wide",
...
if selected == "Home":
    ...
    #with col1:
        ...
        #st.markdown("## :yellow[**Overview :**] In this streamlit web app you can upload an image of a business card and extract relevant information from it using easyOCR. You can view, modify or delete the extracted data in this app. This app would also allow users to save the extracted information into a database along with the uploaded business card image. The database would be able to store multiple entries, each with its own business card image and extracted information.")
#    with col2:
#       st.image("OCR.jpg")
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            save_this = "D:/project/Biz-Card-Extracting-with-OCR/uploaded_cards"
